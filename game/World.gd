...
func spawn_blue_portal(hit_position: Vector2, normal: Vector2)->void:
...
func _on_Player_fired_blue_portal(hit_position: Vector2, normal: Vector2):
    print(hit_position)
    generate_blue_hit_effect(hit_position)
    spawn_blue_portal(hit_position, normal)
...
func spawn_orange_portal(hit_position: Vector2, normal: Vector2)->void:
    var instance = Portal.instance()
    add_child(instance)
    instance.position = hit_position
    # rotating the portal to fit the white layer
...
func _on_Player_fired_orange_portal(hit_position: Vector2, normal: Vector2):
    print(hit_position)
    generate_orange_hit_effect(hit_position)
    spawn_orange_portal(hit_position, normal)
